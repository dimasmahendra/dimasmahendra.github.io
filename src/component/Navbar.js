            ...
            <div className="hero-wrap" id="sec1" data-scrollax-parent="true">
                <div className="hero-inner fl-wrap full-height">
                    <div className="half-slider-img-wrap">
                        <div className="half-slider-img fl-wrap full-height">
                            <div className="half-slider-img-item">
                                <div className="bg"  data-bg="/assets/images/bg/13.jpg" data-scrollax="properties: { translateY: '250px' }" ></div>
                                <div className="overlay"></div>
                            </div>
                            <div className="half-slider-img-item">
                                <div className="bg"  data-bg="/assets/images/bg/29.jpg" data-scrollax="properties: { translateY: '250px' }" ></div>
                                <div className="overlay"></div>
                            </div>
                            <div className="half-slider-img-item">
                                <div className="bg"  data-bg="/assets/images/bg/2.jpg" data-scrollax="properties: { translateY: '250px' }" ></div>
                                <div className="overlay"></div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="slider-nav cur_carousel-slider-container" data-slick='{"autoplay": true, "autoplaySpeed": 4000 , "pauseOnHover": false}'>
                            <div className="half-slider-item fl-wrap">
                                <div className="half-hero-wrap">
                                    <h1>Hey there ! <br/>I'm  Dimas Mahendra Kusuma<br/>Works as <span> Software Engineer </span></h1>
                    ...
                    <div className="hero-decor-numb">
                        <span>110.4232051</span>
                        <span>7.7375238</span> 
                        <a href="https://www.google.com/maps/@-7.7375238,110.4232051,19.73z" rel="noreferrer" target="_blank" className="hero-decor-numb-tooltip">Based In Yogyakarta</a>
                    </div>
