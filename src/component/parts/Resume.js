    ...
    return (
        <section className="parallax-section dark-bg sec-half parallax-sec-half-right" data-scrollax-parent="true" id="sec3">
            ...
            <div className="container">
                ...
                <div className="fl-wrap facts-holder">
                    ...
                    <div className="custom-inner">
                        <div className="row">
                            ...
                            <div className="col-md-3"><img src="/assets/images/all/8.jpg" className="respimg" data-scrollax="properties: { translateY: '270px' }" alt="" /></div>
                        </div>
                    </div>
                    <div className="custom-inner">
                        <div className="row">
                ...
                <a href="{#}" className="btn float-btn flat-btn color-btn mar-top">Download Resume</a>
            </div>
